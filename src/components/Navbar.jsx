...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white px-6 md:px-12 lg:px-24 xl:px-40 py-4 flex items-center justify-between relative font-inter sticky top-0 z-50 shadow-sm">
      ...
      <div className="hidden md:flex items-center bg-zinc-50 border border-zinc-200 rounded-full px-1 py-1 gap-2">
        <a
          href="#"
          className="px-4 py-1.5 rounded-full text-sm transition-colors bg-white border border-zinc-200 font-medium text-zinc-800 hover:text-zinc-600"
        >
          Products
        </a>
        <a
          href="#"
          className="px-4 py-1.5 rounded-full text-sm transition-colors text-zinc-500 hover:text-zinc-400"
        >
          Services
        </a>
        <a
      ...
      <div
        ...
        } absolute top-full left-0 w-full bg-white border-t border-zinc-200 flex-col p-5 gap-1 md:hidden z-50`}
      >
        <a
          href="#"
